...
class SecondViewController: UIViewController {
    ...
    func setUp(){
        ...
        selfIsoLateTextView.text = "Monitor yourself for 14 days for symptoms of respiratory illness, such as cough, fever and difficulty breathing avoid crowded places and increase your personal space from others whenever possible."
